% ########## Setup & Run Muscle Analysis ##########
% 
% Description
% ---------------
% This script writes a subject specific setup file to analyze muscle
% analysis within the Analyze Tool in OpenSim 3.3 and then runs the Analyze
...
%% ========== Part 2: Initial edits of generic structure ==========
...
for iFiles = 1:nFiles
    ...
    waitbar(progress,h,...
        ['Running ' subjectName ' Muscle Analysis. File ' j ' of ' n])
